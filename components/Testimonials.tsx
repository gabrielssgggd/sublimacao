...
const WistiaVideoCard = ({ id }: { id: string }) => {
  ...
  return (
    <div className="w-full h-full relative rounded-xl overflow-hidden shadow-lg bg-dark-900 border border-white/10 hover:border-gold-500/30 transition-colors group">
      <style>{`
...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-dark-950 overflow-hidden relative" id="video-depoimentos">
        {/* Background ambience */}
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-4 uppercase">Depoimentos <span className="text-gold-400">Reais</span> de Clientes</h2>
          <p className="text-gray-400 text-lg">Veja o resultado de quem já está lucrando com a Coleção Zeus.</p>
        </div>
